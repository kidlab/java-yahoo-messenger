...
//
// 						From	ChatUser	ChatUsers	Lobby	Message	Emote  Captcha
// chatLogonReceived	y		y			y			y		n		n      n
// chatLogoffReceived	y		y			y			y		n		n      n
// chatMessageReceived	y		y			y			y		y		y      n
// chatConnectionBroken n		n			n			n		n		n      n
// chatCaptchaReceived  n       n           n           y       n       n      y
// *********************************************************************
...
{	protected YahooChatUser[] users;
	...
	public String getCaptchaMessage() { return captchaMsg; }
